...
Do not publish secrets, exploit payloads, private user data, or abuse steps in a
public issue.
...
- affected page, workflow, Firebase collection, or API surface
...
relevant automated checks, and avoid exposing credentials or project secrets.
